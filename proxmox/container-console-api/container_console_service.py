...
class ContainerConsoleManager:
    ...
    def execute_command(self, container_id: int, command: str, timeout: int = 30) -> CommandResult:
        ...
        try:
            ...
            full_command = ["pct", "exec", str(container_id), "--", "bash", "-c", command]
            ...
            print(f"✅ Command completed in {execution_time:.2f}s (exit code: {result.returncode})")
    ...
    def get_container_info(self, container_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'config': config_result.stdout.strip() if config_result.returncode == 0 else 'unknown',
...
def main():
    ...
    if manager.test_container_access(container_id):
        ...
        result = manager.execute_command(container_id, "echo 'Hello from LibreChat container!' && hostname")
        ...
        system_result = manager.execute_command(container_id, "uname -a && cat /etc/os-release | head -3")
